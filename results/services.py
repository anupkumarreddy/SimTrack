...
def get_or_create_signature(regression_run, title, category=None, description='', is_known_issue=False, is_infra_issue=False):
...
def recalculate_run_counters(run):
    ...
    run.save(update_fields=[
        ...
        'killed_count', 'skip_count', 'unknown_count', 'pass_rate', 'updated_at'
    ])
